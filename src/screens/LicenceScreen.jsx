    ...
    <div style={{ width: "100%", height: "100%", background: "#080808", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <div style={{ padding: "52px 20px 20px", flexShrink: 0 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            ...
            <div style={{ fontFamily: "Georgia,serif", fontSize: 22, fontWeight: 700, color: "white" }}>{t("lic_title")}</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "0 20px 90px" }}>
        ...
        <div style={{ marginBottom: 18 }}>
          <label htmlFor="lic-country" style={{ fontFamily: "monospace", fontSize: 12, color: "#ccc", letterSpacing: 2, marginBottom: 8, display: "block", cursor: "pointer" }}>{t("lic_country")}</label>
        ...
        {/* Licence number */}
        <div style={{ marginBottom: 18 }}>
          <label htmlFor="lic-number" style={{ fontFamily: "monospace", fontSize: 12, color: "#ccc", letterSpacing: 2, marginBottom: 8, display: "block" }}>{t("lic_number")}</label>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 18 }}>
          <div>
            <label htmlFor="lic-issued" style={{ fontFamily: "monospace", fontSize: 12, color: "#ccc", letterSpacing: 2, marginBottom: 8, display: "block" }}>{t("lic_issue")}</label>
          ...
          <div>
            <label htmlFor="lic-expiry" style={{ fontFamily: "monospace", fontSize: 12, color: "#ccc", letterSpacing: 2, marginBottom: 8, display: "block" }}>{t("lic_expiry")}</label>
            <div style={{ background: "#111", border: "1px solid #222", borderRadius: 12, padding: "14px 12px" }}>
        ...
        <div style={{ marginBottom: 28 }}>
          <div style={{ fontFamily: "monospace", fontSize: 12, color: "#aaa", letterSpacing: 2, marginBottom: 12 }}>{t("lic_categories")}</div>
          ...
          <div style={{ fontFamily: "monospace", fontSize: 10, color: "#aaa", letterSpacing: 1, marginTop: 10 }}>{t("lic_categories_hint")}</div>
        </div>
        ...
        {saved ? (
          <div style={{ width: "100%", background: "#0d2a0d", border: "1px solid #4CAF50", borderRadius: 14, padding: "16px", display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
            ...
            <span style={{ fontFamily: "monospace", fontSize: 12, color: "#4CAF50", letterSpacing: 2 }}>{t("lic_saved")}</span>
          </div>
        ) : (
